...
# --- 2. 数据处理 ---
# 区间: 1, 2-5, 6-20, 21-50, 51-100, 101-200, 201-300, 301-400, 401-500,
...
# -------------------------------------------------
# 区域 1：展示 Rank 20, 50, 100 (indices [2, 3, 4])
# -------------------------------------------------
indices_1 = [2, 3, 4]
# 虚线框
...
# 【修改1】左侧子图：缩小尺寸并上移
# 旧: (0.2, 0.45, 0.35, 0.50)
# 新: (0.18, 0.50, 0.32, 0.45) -> x左移, y上移, w缩小, h缩小
...
# 【修改2】左侧箭头调整
# 目标(xy): 子图底部中心 (0.18 + 0.32/2 = 0.34, y=0.50)
# 起点(xytext): 保持在 '50' 刻度上方 (0.28, 0.12)
ax.annotate('',
...
# 【修改3】右侧子图：缩小尺寸并上移，保持与左侧对齐
# 旧: (0.63, 0.45, 0.35, 0.50)
# 新: (0.65, 0.50, 0.32, 0.45) -> x右移, y上移, w缩小, h缩小
...
# 【修改4】右侧箭头调整
# 目标(xy): 子图底部中心 (0.65 + 0.32/2 = 0.81, y=0.50)
# 起点(xytext): 保持不变 (0.82, 0.07)
ax.annotate('',
