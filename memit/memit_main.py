...
def apply_memit_to_model(
    ...
    # save_dir = Path("./edit_memit_amount")
    # save_dir = Path("./multi_case_edit_memit_amount")

    save_dir = Path("./multi_case_edit_memit_amount_attack")
    with torch.no_grad():
...
def execute_memit(
    ...
    # save_dir = Path("./edit_memit_amount") # (硬编码，因为我们不能改参数)
    # save_dir = Path("./multi_case_edit_memit_amount")
    save_dir = Path("./multi_case_edit_memit_amount_attack")
